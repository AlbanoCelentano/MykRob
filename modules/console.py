...
class Console:
    ...
    def title_thread():
        ...
        while True:
            ...
            os.system(f'title [SMG SHOP - TGen] Stats: [L: {Console._locked} / U: {Console._unlocked}] - Verified: {Console._verified} - Unchecked: {Console._generated - (Console._locked + Console._unlocked)} | CapSolvd: {Console._hcap_solved} @ {cap_solve_rate}/m | ProxyERR: {Console._proxy_err} | Workers: {Console._cap_worker} - Threads: {threading.active_count()} | {all_token_min}/m - {work_token_min}V/m | Elapsed: {ctime}s'.replace('|', '^|'))
  ...
  {Fore.CYAN}░██████╗███╗░░░███╗░██████╗░
  {Fore.CYAN}██╔════╝████╗░████║██╔════╝░
  {Fore.CYAN}╚█████╗░██╔████╔██║██║░░██╗░              {Fore.BLUE}https://discord.gg/smg-shop
  {Fore.CYAN}░╚═══██╗██║╚██╔╝██║██║░░╚██╗        
  {Fore.CYAN}██████╔╝██║░╚═╝░██║╚██████╔╝
